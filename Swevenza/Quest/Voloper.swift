...
class RandomEmploye {
    ...
    init() {
        ...
        self.name = RandomEmploye.generateRandomNames()
        self.department = RandomEmploye.departments.randomElement()!
        self.position = RandomEmploye.generatePositions(for: department)
        self.salary = RandomEmploye.generateSalarys(for: department)
        self.yearsExperience = Int.random(in: 0...20)
        self.skills = RandomEmploye.generateSkillss()
        self.startDate = RandomEmploye.generateStartDates()
    }
    ...
    private static func generateRandomNames() -> String {
    ...
    private static func generatePositions(for department: String) -> String {
        return positions[department]!.randomElement()!
    }
    
    private static func generateSalarys(for department: String) -> Double {
        ...
        return Double.random(in: min...max).rounded()
    }
     ...
     static func generateStartDates() -> Date {
